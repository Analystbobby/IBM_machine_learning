...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec, 
                          ...
                          title=f'Total Advertisement Expenditure by Vehicle Type during Recession'))

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        une_rec=recession_data.groupby('Vehicle_Type')['unemployment_rate'].sum().reset_index()
        R_chart4  = dcc.Graph(figure=px.bar(une_rec,
                                            x='Vehicle_Type',
                                            y='unemployment_rate',
                                            title='effect on employment on vehicle type'))
